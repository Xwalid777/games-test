const GameCard = ({ game }) => {
    return (
        <div className="w-80 bg-white shadow rounded">
            <div className=" relative h-48 w-full bg-gray-200 object-cover bg-center flex flex-col justify-between p-4 bg-cover bg-center">
            ...
            <div className="p-4 flex flex-col items-center">
                ...
                <h1 className="text-gray-800 text-center mt-1">{game.name}</h1>
                <p className="text-center text-gray-800 mt-1">€{game.price}</p>
